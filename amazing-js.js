...
const events = [
  ...
  function createEventModal(event, index) {
    ...
    closeButton.innerHTML = '<img src="images/close-button.svg">';
    ...
    const eventHost = createInfoElement("event-host", "images/event-host.svg", event.eventHost);
    const eventDate = createInfoElement("event-date", "images/calendar.svg", event.eventDate);
